...
class LoadInfrastructureInitializer(
    ...
    private val loadWorkers: ConsumerWorkerHolder<LoadTask>,
    ...
    private fun createMongoIndexes() {
        runBlocking {
            FailedLoadTaskRepositoryIndexes.ensureIndexes(mongo)
            RetryLoadTaskRepositoryIndexes.ensureIndexes(mongo)
        }
    }
